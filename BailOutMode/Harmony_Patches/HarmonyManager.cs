...
namespace BailOutMode.Harmony_Patches
{
    public static class HarmonyManager
    {
        ...
        {
            AddDefaultPatch<GameEnergyCounterProcessEnergyChange>();
            AddDefaultPatch<StandardLevelGameplayManagerHandleSongDidFinish>();
            AddDefaultPatch<MultiplayerLocalActivePlayerGameplayManagerHandleSongDidFinish>();
            AddDefaultPatch<MultiplayerLocalActiveClient_ScoreControllerHandleScoreDidChange>();
            AddDefaultPatch<ScoreController_prevFrameRawScore>();
            AddDefaultPatch<ScoreController_prevprevFrameModifiedScore>();
        }
